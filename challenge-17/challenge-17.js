...
*/
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/, "Daniele Ligieri Castilho")
  );
  /*
...
*/
  ...
  console.log(text.replace(/brasileiro/, "paulistano"));
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/, function(texto) {
